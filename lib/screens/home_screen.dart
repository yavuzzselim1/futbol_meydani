        ...
        child: ClipRRect(
          ...
          child: Stack(
            children: [
              ...
              Container(
                padding: EdgeInsets.fromLTRB(7, 4, showAdd ? 5 : 8, 4),
                decoration: _gradientBox(
                  colors: bgColors,
...
class _AvatarPreviewOverlayWidgetState extends State<_AvatarPreviewOverlayWidget> with SingleTickerProviderStateMixin {
  ...
  Widget _buildProfileView() {
    return Column(
      ...
      children: [
        Text(
          gameStore.playerName.toUpperCase(),
          maxLines: 1,
          overflow: TextOverflow.ellipsis,
          style: GoogleFonts.oswald(
            color: Colors.white,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: _kGreen0.withValues(alpha: 0.2),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: _kGreen0.withValues(alpha: 0.5)),
          ),
          child: Text(
            'SEVİYE ${gameStore.level}',
            style: GoogleFonts.inter(
              color: _kGreen0,
              fontSize: 12,
              fontWeight: FontWeight.w800,
        ...
        Row(
          ...
          children: [
            _StatBox(
              icon: Icons.emoji_events_rounded, 
              label: 'KUPA', 
              value: gameStore.trophies.toString(), 
              color: _kGold1
            ),
            _StatBox(
              icon: Icons.monetization_on_rounded, 
              label: 'JETON', 
              value: gameStore.coins.toString(), 
              color: _kGreen0
            ),
          ],
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(colors: [_kNavy0, Colors.black87]),
  ...
  Widget _buildQrView() {
    final fCode = gameStore.friendCode;
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(16),
            boxShadow: [
              BoxShadow(color: _kGreen0.withValues(alpha: 0.2), blurRadius: 20, spreadRadius: 2),
            ],
          ),
          child: QrImageView(
            data: fCode.isNotEmpty ? fCode : 'no_code',
  ...
  Widget _buildCardContent() {
    return Container(
      decoration: BoxDecoration(
        color: _kNavy0.withValues(alpha: 0.85),
        borderRadius: BorderRadius.circular(28),
        border: Border.all(color: Colors.white.withValues(alpha: 0.15), width: 1.5),
        boxShadow: [
          const BoxShadow(color: Colors.black54, blurRadius: 20, offset: Offset(0, 10)),
          BoxShadow(color: _kGreen0.withValues(alpha: 0.1), blurRadius: 30, spreadRadius: 5),
        ]
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(28),
        child: BackdropFilter(
          ...
          child: Padding(
            padding: const EdgeInsets.only(top: 65, left: 24, right: 24, bottom: 24),
            child: AnimatedSwitcher(
              ...
              child: _showQr ? _buildQrView() : _buildProfileView(),
            ),
          ),
        )
      )
      ...
      children: [
          ...
          child: GestureDetector(
            ...
            child: AnimatedBuilder(
              ...
              builder: (_, __) => Container(
                color: Colors.black.withValues(alpha: _anim.value * 0.75),
              ),
            ),
          ),
        ),
        AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            final cardWidth = (screenSize.width * 0.85).clamp(280.0, 360.0);
            final cardHeight = 440.0;
            final targetSize = 110.0;
            
            final cardLeft = (screenSize.width - cardWidth) / 2;
            final cardTop = (screenSize.height - cardHeight) / 2 + 30; 
            
            final targetOffset = Offset(
              (screenSize.width - targetSize) / 2,
              cardTop - targetSize / 2, 
            );
                ...
                Positioned(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withValues(alpha: 0.4 * _anim.value),
                          blurRadius: 15,
                          offset: const Offset(0, 8),
                        )
                      ]
